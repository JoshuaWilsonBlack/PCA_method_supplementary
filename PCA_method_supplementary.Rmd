...
locations in New Zealand’s South Island. This paper takes processed data from
...
the original variables. If we look at the column for PC2, we see positive
...
_should not be interpreted_ (e.g. [Björklund (2019)](https://onlinelibrary.wiley.com/doi/full/10.1111/evo.13835)).
We believe that this is an excessive response to the problem and will offer a
solution in the following section. However, we agree with Björklund that 
...
is 'significant'. The red bars indicate the 90% intervals for the index loading.
...
This is exactly what we find in Figure \@ref(fig:pc1-loadings). Björklund
